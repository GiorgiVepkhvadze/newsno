...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2020 at 03:25 PM
...
(9, 'სათაური ქართულად', 'სათაური ინგლისურად', 'სათაური რუსულად', '<p>საქართველოს განათლების, მეცნიერების, კულტურისა და სპორტის მინისტრი მიხეილ ჩხენკელი სსიპ კულტურული მემკვიდრეობის დაცვის ეროვნული სააგენტოს ანგარიშის წარდგენას დაესწრო და საზოგადოებას სიტყვით მიმართა.</p>\r\n\r\n<p><strong>მიხეილ ჩხენკელი:</strong>&nbsp;&bdquo;დღეს ჩვენ სამინისტროს შემადგენლობაში შემავალი, მე ვიტყოდი, განსაკუთრებული, კულტურული მემკვიდრეობის დაცვის ეროვნული სააგენტოს პრეზენტაციას ვესწრებით, რომელიც ჭეშმარიტად უზარმაზარ საქმეს ემსახურება. ჩვენი კულტურის, ჩვენი ისტორიული მემკვიდრეობის დაცვა ყოველი ჩვენგანის მოვალეობაა, რადგანაც ეს არის ჩვენი კულტურული იდენტობის ქვაკუთხედი. საქართველოს კულტურული მემკვიდრეობა არის ჩვენი მთავარი განძი. იგი მკაფიოდ მეტყველებს, რომ საქართველო არა მხოლოდ ევროპის ნაწილია, არამედ მისი ღირებულებების შექმნაში უდიდესი წვლილი მიუძღვის. სწორედ კულტურული მემკვიდრეობით გაიცნო მთელმა მსოფლიომ და ხელახლა აღმოაჩინა საქართველო, როგორც უნიკალური ქვეყანა, განსაკუთრებული ისტორიით, მდიდარი ფესვებით. ის ძალიან დიდი შრომა, რომელიც ჩაქსოვილია ჩვენი ისტორიული ძეგლების მოვლა-პატრონობის საქმეში, რასაკვირველია, სააგენტოს თითოეულ თანამშრომლისა და მათი ხელმძღვანელის დამსახურებაა და მინდა, მთელი გულით დიდი მადლობა გადაგიხადოთ.&ldquo;</p>\r\n\r\n<p>კულტურული მემკვიდრეობის ძეგლების დაცვის საქმეში შეტანილი განსაკუთრებული წვლილისათვის მინისტრმა მადლობა გადაუხადა ბატონ ბიძინა ივანიშვილსა და ფონდ &bdquo;ქართუს&ldquo;. მისი თქმით, ამ მასშტაბისა და ხარისხის პროექტები ვერ განხორციელდებოდა ამ ფონდის ქველმოქმედების გარეშე.</p>\r\n\r\n<p>მიხეილ ჩხენკელმა გამოყო კულტურული მემკვიდრეობის დაცვის ეროვნული სააგენტოს მიერ განხორციელებული პროექტები, რომელთაც საგანმანათლებლო მნიშვნელობა აქვთ. მან აღნიშნა, რომ სამინისტრო გააფართოებს იმ პროექტებს, რომლებიც ითვალისწინებს მოსწავლეების ადრეული ასაკიდან ურთიერთობას ძეგლთან და ამ გზით საქართველოს უმდიდრესი ისტორიის შესწავლას. მინისტრმა სააგენტოს იმ პროექტებზეც ისაუბრა, რომლებიც უცხოელ მეცნიერებთან პარტნიორობით ხორციელდება.</p>\r\n\r\n<p>როგორც მიხეილ ჩხენკელმა სიტყვით გამოსვლისას აღნიშნა, პანდემიამ კიდევ ერთხელ დაანახა მსოფლიოს ტექნოლოგიების მნიშვნელობა, რომელიც ცხოვრების ყველა სფეროს განუყოფელი ნაწილი გახდა. მან ხაზი გაუსვა, რომ კულტურული მემკვიდრეობის ეროვნული სააგენტო იყენებს თანამედროვე ტექნოლოგიებს უცხოელ კოლეგებთან ერთად, რათა მთელ მსოფლიოს ჰქონდეს საშუალება, ვირტუალურ სივრცეში იხილოს ის ჭეშმარიტად ზოგადსაკაცობრიო განძი, რომელიც საქართველოში მდებარეობს</p>', '<p>საქართველოს განათლების, მეცნიერების, კულტურისა და სპორტის მინისტრი მიხეილ ჩხენკელი სსიპ კულტურული მემკვიდრეობის დაცვის ეროვნული სააგენტოს ანგარიშის წარდგენას დაესწრო და საზოგადოებას სიტყვით მიმართა.</p>\r\n\r\n<p><strong>მიხეილ ჩხენკელი:</strong>&nbsp;&bdquo;დღეს ჩვენ სამინისტროს შემადგენლობაში შემავალი, მე ვიტყოდი, განსაკუთრებული, კულტურული მემკვიდრეობის დაცვის ეროვნული სააგენტოს პრეზენტაციას ვესწრებით, რომელიც ჭეშმარიტად უზარმაზარ საქმეს ემსახურება. ჩვენი კულტურის, ჩვენი ისტორიული მემკვიდრეობის დაცვა ყოველი ჩვენგანის მოვალეობაა, რადგანაც ეს არის ჩვენი კულტურული იდენტობის ქვაკუთხედი. საქართველოს კულტურული მემკვიდრეობა არის ჩვენი მთავარი განძი. იგი მკაფიოდ მეტყველებს, რომ საქართველო არა მხოლოდ ევროპის ნაწილია, არამედ მისი ღირებულებების შექმნაში უდიდესი წვლილი მიუძღვის. სწორედ კულტურული მემკვიდრეობით გაიცნო მთელმა მსოფლიომ და ხელახლა აღმოაჩინა საქართველო, როგორც უნიკალური ქვეყანა, განსაკუთრებული ისტორიით, მდიდარი ფესვებით. ის ძალიან დიდი შრომა, რომელიც ჩაქსოვილია ჩვენი ისტორიული ძეგლების მოვლა-პატრონობის საქმეში, რასაკვირველია, სააგენტოს თითოეულ თანამშრომლისა და მათი ხელმძღვანელის დამსახურებაა და მინდა, მთელი გულით დიდი მადლობა გადაგიხადოთ.&ldquo;</p>\r\n\r\n<p>კულტურული მემკვიდრეობის ძეგლების დაცვის საქმეში შეტანილი განსაკუთრებული წვლილისათვის მინისტრმა მადლობა გადაუხადა ბატონ ბიძინა ივანიშვილსა და ფონდ &bdquo;ქართუს&ldquo;. მისი თქმით, ამ მასშტაბისა და ხარისხის პროექტები ვერ განხორციელდებოდა ამ ფონდის ქველმოქმედების გარეშე.</p>\r\n\r\n<p>მიხეილ ჩხენკელმა გამოყო კულტურული მემკვიდრეობის დაცვის ეროვნული სააგენტოს მიერ განხორციელებული პროექტები, რომელთაც საგანმანათლებლო მნიშვნელობა აქვთ. მან აღნიშნა, რომ სამინისტრო გააფართოებს იმ პროექტებს, რომლებიც ითვალისწინებს მოსწავლეების ადრეული ასაკიდან ურთიერთობას ძეგლთან და ამ გზით საქართველოს უმდიდრესი ისტორიის შესწავლას. მინისტრმა სააგენტოს იმ პროექტებზეც ისაუბრა, რომლებიც უცხოელ მეცნიერებთან პარტნიორობით ხორციელდება.</p>\r\n\r\n<p>როგორც მიხეილ ჩხენკელმა სიტყვით გამოსვლისას აღნიშნა, პანდემიამ კიდევ ერთხელ დაანახა მსოფლიოს ტექნოლოგიების მნიშვნელობა, რომელიც ცხოვრების ყველა სფეროს განუყოფელი ნაწილი გახდა. მან ხაზი გაუსვა, რომ კულტურული მემკვიდრეობის ეროვნული სააგენტო იყენებს თანამედროვე ტექნოლოგიებს უცხოელ კოლეგებთან ერთად, რათა მთელ მსოფლიოს ჰქონდეს საშუალება, ვირტუალურ სივრცეში იხილოს ის ჭეშმარიტად ზოგადსაკაცობრიო განძი, რომელიც საქართველოში მდებარეობს</p>', '<p>საქართველოს განათლების, მეცნიერების, კულტურისა და სპორტის მინისტრი მიხეილ ჩხენკელი სსიპ კულტურული მემკვიდრეობის დაცვის ეროვნული სააგენტოს ანგარიშის წარდგენას დაესწრო და საზოგადოებას სიტყვით მიმართა.</p>\r\n\r\n<p><strong>მიხეილ ჩხენკელი:</strong>&nbsp;&bdquo;დღეს ჩვენ სამინისტროს შემადგენლობაში შემავალი, მე ვიტყოდი, განსაკუთრებული, კულტურული მემკვიდრეობის დაცვის ეროვნული სააგენტოს პრეზენტაციას ვესწრებით, რომელიც ჭეშმარიტად უზარმაზარ საქმეს ემსახურება. ჩვენი კულტურის, ჩვენი ისტორიული მემკვიდრეობის დაცვა ყოველი ჩვენგანის მოვალეობაა, რადგანაც ეს არის ჩვენი კულტურული იდენტობის ქვაკუთხედი. საქართველოს კულტურული მემკვიდრეობა არის ჩვენი მთავარი განძი. იგი მკაფიოდ მეტყველებს, რომ საქართველო არა მხოლოდ ევროპის ნაწილია, არამედ მისი ღირებულებების შექმნაში უდიდესი წვლილი მიუძღვის. სწორედ კულტურული მემკვიდრეობით გაიცნო მთელმა მსოფლიომ და ხელახლა აღმოაჩინა საქართველო, როგორც უნიკალური ქვეყანა, განსაკუთრებული ისტორიით, მდიდარი ფესვებით. ის ძალიან დიდი შრომა, რომელიც ჩაქსოვილია ჩვენი ისტორიული ძეგლების მოვლა-პატრონობის საქმეში, რასაკვირველია, სააგენტოს თითოეულ თანამშრომლისა და მათი ხელმძღვანელის დამსახურებაა და მინდა, მთელი გულით დიდი მადლობა გადაგიხადოთ.&ldquo;</p>\r\n\r\n<p>კულტურული მემკვიდრეობის ძეგლების დაცვის საქმეში შეტანილი განსაკუთრებული წვლილისათვის მინისტრმა მადლობა გადაუხადა ბატონ ბიძინა ივანიშვილსა და ფონდ &bdquo;ქართუს&ldquo;. მისი თქმით, ამ მასშტაბისა და ხარისხის პროექტები ვერ განხორციელდებოდა ამ ფონდის ქველმოქმედების გარეშე.</p>\r\n\r\n<p>მიხეილ ჩხენკელმა გამოყო კულტურული მემკვიდრეობის დაცვის ეროვნული სააგენტოს მიერ განხორციელებული პროექტები, რომელთაც საგანმანათლებლო მნიშვნელობა აქვთ. მან აღნიშნა, რომ სამინისტრო გააფართოებს იმ პროექტებს, რომლებიც ითვალისწინებს მოსწავლეების ადრეული ასაკიდან ურთიერთობას ძეგლთან და ამ გზით საქართველოს უმდიდრესი ისტორიის შესწავლას. მინისტრმა სააგენტოს იმ პროექტებზეც ისაუბრა, რომლებიც უცხოელ მეცნიერებთან პარტნიორობით ხორციელდება.</p>\r\n\r\n<p>როგორც მიხეილ ჩხენკელმა სიტყვით გამოსვლისას აღნიშნა, პანდემიამ კიდევ ერთხელ დაანახა მსოფლიოს ტექნოლოგიების მნიშვნელობა, რომელიც ცხოვრების ყველა სფეროს განუყოფელი ნაწილი გახდა. მან ხაზი გაუსვა, რომ კულტურული მემკვიდრეობის ეროვნული სააგენტო იყენებს თანამედროვე ტექნოლოგიებს უცხოელ კოლეგებთან ერთად, რათა მთელ მსოფლიოს ჰქონდეს საშუალება, ვირტუალურ სივრცეში იხილოს ის ჭეშმარიტად ზოგადსაკაცობრიო განძი, რომელიც საქართველოში მდებარეობს</p>', '15921994039.jpg', '15921994039.jpg', '2020-06-15 05:36:40', 0);
...
(1, '<p>sdf</p>', '<p>sdfsdf</p>', '<p>sdfsdf</p>', '<p>sdfdsf</p>', '<p>sdfsdfsf</p>', '<p>sdfsdf</p>', '<p>sdfsdf</p>', '<p>sdfsdf</p>', '<p>sdfsdf</p>', '<p>sdfsdf</p>', '<p>sdfsdfsd</p>', '<p>sdfsdfsdf</p>', '<p>sdfsdfsdf</p>', '<p>sdfsdfsd</p>', '<p>fsdfsdfsdf</p>', '15922267861.jpg', '159222680013.jpg', '159222682634.jpg');
