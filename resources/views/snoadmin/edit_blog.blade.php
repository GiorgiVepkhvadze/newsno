            ...
            <div class="container-fluid">
               <div class="row">
                  ...
                  <div class="col-sm-12 col-lg-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <form method="POST" action="{{ route('edit_blog_update', $Blog->blog_id) }}" enctype="multipart/form-data">
                              @csrf
                              @method("PATCH")
                              <div class="form-group">
                                 <label for="exampleInputPlaceholder">მონიშნეთ ფოტო</label>
                                 <input type="file" class="form-control-file" name="filesToUpload1" >
                              </div>

                              <div class="form-group">
                                 <label for="exampleInputPlaceholder">სათაური ქართულად</label>
                                 <input type="text" class="form-control" name="blog_title_ka" value="{{ $Blog->blog_title_ka }}" required>
                              </div>


                              <div class="form-group">
                                 <label for="exampleInputPlaceholder">სათაური ინგლისურად</label>
                                 <input type="text" class="form-control" name="blog_title_en" value="{{ $Blog->blog_title_en }}" required>
                              </div>


                              <div class="form-group">
                                 <label for="exampleInputPlaceholder">სათაური რუსულად</label>
                                 <input type="text" class="form-control" name="blog_title_ru" value="{{ $Blog->blog_title_ru }}" required>
                              </div>
                  ...
                  <br>            
                              ...
                              <button class="btn btn-primary" type="submit">ბლოგის რედაქტირება</button>
                           </form>
                        </div>
                     </div>
