                  ...
                  <div class="col-sm-12 col-lg-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <form method="POST" action="{{ route('sno_mineral_update') }}">
                  ...
                  <div class="col-sm-6 col-lg-6">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <form method="POST" action="{{ route('sno_mineral_update_image_one') }}" enctype="multipart/form-data">
                              @csrf
                     ...
                     <div class="col-sm-6 col-lg-6">
                        <div class="iq-card">
                           ...
                           <div class="iq-card-body">
                              ...
                              <form method="POST" action="{{ route('sno_mineral_update_image_two') }}" enctype="multipart/form-data">
                                 @csrf
                        ...
                        <div class="col-sm-6 col-lg-6">
                           <div class="iq-card">
                              ...
                              <div class="iq-card-body">
                                 ...
                                 <form method="POST" action="{{ route('sno_mineral_update_image_three') }}" enctype="multipart/form-data">
                                    @csrf
